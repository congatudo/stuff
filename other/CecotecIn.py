...
class Module:
    def __init__(self, incoming=False, verbose=False, options=None):
        ...
        self.description = 'Cecotec protocol in module'
    ...
    def execute(self, data):
        ...
        #command1="grep '\s"+strcommand+"\s' robotfuntions | awk '{print $NF}' | xargs"
        ...
        if len(data)>24:
            ...
            with open("blob-file-in", "wb") as f: f.write(binary_data)
            stdout=os.popen('../protobuf-inspector/main.py < blob-file-in').read() 
            print(stdout)
